                ...
                switch (field.ID)
                {
                        ...
                        {
                            {
                                ...
                                for (int _i257 = 0; _i257 < _list253.Count; ++_i257)
                                {
                                    AutocompleteHit _elem258;
                                    _elem258 = new AutocompleteHit();
                                    _elem258.Read(iprot);
                                    Hits.Add(_elem258);
                                }
                                iprot.ReadListEnd();
                    ...
                    case 31:
                        if (field.Type == TType.List)
                        {
                            ...
                            for (int _i263 = 0; _i263 < _list259.Count; ++_i263)
                            {
                                PropertyResult _elem264;
                                _elem264 = new PropertyResult();
                                _elem264.Read(iprot);
                                propertyResults.Add(_elem264);
                            }
                            iprot.ReadListEnd();
                        }
                        else
