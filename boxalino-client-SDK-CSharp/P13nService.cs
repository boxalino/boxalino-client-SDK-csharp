...
namespace boxalino_client_SDK_CSharp
{
    ...
    public IAsyncResult send_autocomplete(AsyncCallback callback, object state, AutocompleteRequest request)
      ...
      return oprot_.Transport.BeginFlush(callback, state);
            ...
            public void send_autocompleteAll(AutocompleteRequestBundle bundle)
            {
                ...
                args.bundle = bundle;
                bool bin_accel = (this.OutputProtocol is TBinaryProtocolAccelerated) && Common.method_exists(this, "thrift_protocol_write_binary");
                if (bin_accel)
                {
                ...
                else
                {
                    ...
                    me.Name = "autocompleteAll";
                    me.Type = TMessageType.Call;
                    me.SeqID = this.seqid_;
                    this.OutputProtocol.WriteMessageBegin(me);
                    args.write(this.OutputProtocol);
                    this.OutputProtocol.WriteMessageEnd();
                    this.OutputProtocol.getTransport().Flush();
                }
    ...
    public IAsyncResult send_updateChoice(AsyncCallback callback, object state, ChoiceUpdateRequest choiceUpdateRequest)
      ...
      return oprot_.Transport.BeginFlush(callback, state);
        ...
        [Serializable]
#endif
        public partial class autocompleteAll_args
        {
            public AutocompleteRequestBundle bundle = null;
            ...
            public void read(TProtocol input)
            {
                ...
                while (true)
                {
                    ...
                    switch (field.ID)
                    {
                        case -1:
                            if (field.Type == TType.Struct)
                            {
                                this.bundle = new AutocompleteRequestBundle();
            ...
            public void write(TProtocol output)
            {

                TStruct tsruct = new TStruct();
                tsruct.Name = "P13nService_autocompleteAll_args";
                output.WriteStructBegin(tsruct);
                if (this.bundle != null)
                {
                    if (!(this.bundle is object))
                    {
                        throw new TProtocolException(TProtocolException.INVALID_DATA, "Bad type in structure.");
                    }
                    TField field = new TField();
                    field.Name = "bundle";
                    field.Type = TType.Struct;
        ...
        [Serializable]
#endif
        public partial class autocompleteAll_result
        {
                ...
                while (true)
                {
                    ...
                    switch (field.ID)
                    {
                        case 0:
                            if (field.Type == TType.Struct)
                            {
                                this.Success = new AutocompleteResponseBundle();
            ...
            public void Write(TProtocol oprot)
            {
                TStruct struc = new TStruct("P13nService_autocompleteAll_result");
                oprot.WriteStructBegin(struc);
                TField field = new TField();
